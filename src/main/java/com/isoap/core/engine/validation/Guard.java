package com.isoap.core.engine.validation;

import com.isoap.core.engine.translator.MessageTranslator;
...
public class Guard {
	...
	public static void throwsException(String key, Object... args){
		throw new IsoapExcetion(MessageTranslator.translate(key, args));
	}
	
	public static void throwsException(String key){
		throw new IsoapExcetion(MessageTranslator.translate(key));
	}
}
